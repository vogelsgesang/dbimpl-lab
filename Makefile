...
.PHONY: all
all: $(addsuffix $(BIN_SUFFIX), bin/runTests bin/tpcc bin/olap bin/tpcc_olap bin/generate_schema bin/generate_query bin/execute_query bin/cli)
